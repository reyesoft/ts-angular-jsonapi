...
export class Converter {
    ...
    **/
    static json_array2resources_array(
        ...
        destination_array?: Object, // Array<IResource>,
        use_id_for_key = false
    ): Object { // Array<IResource> {
    ...
    **/
    ...
    static getService(type: string): IResource {
    ...
    static procreate(resource_service: IResource, data: IDataResource): IResource {
    ...
    static _buildResource(document_from: IDataResource, resource_dest: IResource, schema: Jsonapi.ISchema, included) {
    ...
    static __buildRelationship(relation: IDataResource, included_array): IResource | IDataResource {
