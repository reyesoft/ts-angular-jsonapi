    ...
    constructor(
        ...
        this.book = BooksService.get(
            ...
            success => {
                ...
                // console.log('success book object', this.book.toObject({ include: ['users', 'photos'] }));
                // console.log('success book relationships', this.book.toObject({ include: ['users', 'photos'] }).data.relationships);
                // console.log('success book included', this.book.toObject({ include: ['users', 'photos'] }).included);
            },
            error => {
