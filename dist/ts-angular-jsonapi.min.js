...
var Jsonapi;!function(t){var e=function(){function e(){this.is_new=!0,this.relationships={}}return e.prototype.clone=function(){var t=new this.constructor;for(var e in this)"object"!=typeof this[e]&&(t[e]=this[e]);return t},e.prototype.register=function(){if(null===t.Core.Me)throw"Error: you are trying register --> "+this.type+" <-- before inject JsonapiCore somewhere, almost one time.";return this.cache={},t.Core.Me._register(this)},e.prototype.getPath=function(){return this.path?this.path:this.type},e.prototype["new"]=function(){var t=this.clone();return t.reset(),t},e.prototype.reset=function(){var t=this;this.id="",this.attributes={},this.relationships={},angular.forEach(this.schema.relationships,function(e,i){t.relationships[i]={},t.relationships[i].data={}}),this.is_new=!0},e.prototype.toObject=function(e){var i=this;e=angular.extend({},t.Base.Params,e),this.schema=angular.extend({},t.Base.Schema,this.schema);var a={},n=[],s=[];angular.forEach(this.relationships,function(t,r){if(i.schema.relationships[r]&&i.schema.relationships[r].hasMany)a[r]={data:[]},angular.forEach(t.data,function(t){var i={id:t.id,type:t.type};a[r].data.push(i);var h=t.type+"_"+t.id;-1===s.indexOf(h)&&-1!==e.include.indexOf(r)&&(s.push(h),n.push(t.toObject({}).data))});else{"id"in t.data||console.warn(r+" defined with hasMany:false, but I have a collection"),a[r]={data:{id:t.data.id,type:t.data.type}};var h=t.data.type+"_"+t.data.id;-1===s.indexOf(h)&&-1!==e.include.indexOf(t.data.type)&&(s.push(h),n.push(t.data.toObject({}).data))}});var r={data:{type:this.type,id:this.id,attributes:this.attributes,relationships:a}};return n.length>0&&(r.included=n),r},e.prototype.get=function(t,e,i,a){return this.__exec(t,e,i,a,"get")},e.prototype["delete"]=function(t,e,i,a){this.__exec(t,e,i,a,"delete")},e.prototype.all=function(t,e,i){return this.__exec(null,t,e,i,"all")},e.prototype.save=function(t,e,i){return this.__exec(null,t,e,i,"save")},e.prototype.__exec=function(e,i,a,n,s){switch(angular.isFunction(i)?(n=a,a=i,i=t.Base.Params):i=angular.isUndefined(i)?t.Base.Params:angular.extend({},t.Base.Params,i),a=angular.isFunction(a)?a:function(){},n=angular.isFunction(n)?n:function(){},this.schema=angular.extend({},t.Base.Schema,this.schema),s){case"get":return this._get(e,i,a,n);case"delete":return this._delete(e,i,a,n);case"all":return this._all(i,a,n);case"save":return this._save(i,a,n)}},e.prototype._get=function(e,i,a,n){var s=this,r=new t.PathMaker;r.addPath(this.getPath()),r.addPath(e),i.include?r.setInclude(i.include):null;var h=this.getService().cache&&this.getService().cache[e]?this.getService().cache[e]:this["new"]();return t.Core.Services.JsonapiHttp.get(r.get()).then(function(e){t.Converter.build(e.data,h,s.schema),s.fillCacheResource(h),a(e)},function(t){n(t)}),h},e.prototype._all=function(e,i,a){var n=this,s=new t.PathMaker;s.addPath(this.getPath()),e.include?s.setInclude(e.include):null;var r={};return this.getService().cache&&this.getService().cache.__path===this.getPath()&&angular.forEach(this.getService().cache,function(t,e){r[e]=t}),t.Core.Services.JsonapiHttp.get(s.get()).then(function(e){t.Converter.build(e.data,r,n.schema),n.fillCache(r),i(e)},function(t){a(t)}),r},e.prototype._delete=function(e,i,a,n){var s=new t.PathMaker;s.addPath(this.getPath()),s.addPath(e),t.Core.Services.JsonapiHttp["delete"](s.get()).then(function(t){a(t)},function(t){n(t)})},e.prototype._save=function(e,i,a){var n=this.toObject(e),s=new t.PathMaker;s.addPath(this.getPath()),this.id&&s.addPath(this.id),e.include?s.setInclude(e.include):null;var r=this["new"](),h=t.Core.Services.JsonapiHttp.exec(s.get(),this.id?"PUT":"POST",n);return h.then(function(t){var e=t.data.data;r.attributes=e.attributes,r.id=e.id,i(t)},function(t){a("data"in t?t.data:t)}),r},e.prototype.addRelationship=function(t,e){e=e?e:t.type,e in this.relationships||(this.relationships[e]={data:{}});var i=t.id;i||(i="new_"+Math.floor(1e5*Math.random())),this.relationships[e].data[i]=t},e.prototype.removeRelationship=function(t,e){return t in this.relationships&&"data"in this.relationships[t]&&e in this.relationships[t].data?(delete this.relationships[t].data[e],!0):!1},e.prototype.fillCache=function(t){t.id?this.fillCacheResource(t):(this.getService().cache.__path=this.getPath(),this.fillCacheResources(t))},e.prototype.fillCacheResources=function(t){var e=this;angular.forEach(t,function(t){e.fillCacheResource(t)})},e.prototype.fillCacheResource=function(t){t.id&&(this.getService().cache[t.id]=t)},e.prototype.getService=function(){return t.Converter.getService(this.type)},e}();t.Resource=e}(Jsonapi||(Jsonapi={}));
