...
var Jsonapi;!function(t){var e=function(){function e(t,e,n,i){this.$http=t,this.$timeout=e,this.rsJsonapiConfig=n,this.$q=i}return e.$inject=["$http","$timeout","rsJsonapiConfig","$q"],e.prototype["delete"]=function(t){return this.exec(t,"DELETE")},e.prototype.get=function(t){return this.exec(t,"GET")},e.prototype.exec=function(e,n,i){var o={method:n,url:this.rsJsonapiConfig.url+e,headers:{"Content-Type":"application/vnd.api+json"}};i&&(o.data=i);var r=this.$http(o),s=this.$q.defer(),a=this;return t.Core.Me.refreshLoadings(1),r.then(function(e){a.$timeout(function(){t.Core.Me.refreshLoadings(-1),s.resolve(e)},a.rsJsonapiConfig.delay)},function(e){t.Core.Me.refreshLoadings(-1),s.reject(e)}),s.promise},e}();t.Http=e,angular.module("Jsonapi.services").service("JsonapiHttp",e)}(Jsonapi||(Jsonapi={}));
