!function(n){n.module("Jsonapi.config",[]).constant("rsJsonapiConfig",{url:"http://yourdomain/api/v1/",delay:0,unify_concurrency:!0,cache_prerequests:!0}),n.module("Jsonapi.services",[]),n.module("rsJsonapi",["Jsonapi.config","Jsonapi.services"])}(angular);
