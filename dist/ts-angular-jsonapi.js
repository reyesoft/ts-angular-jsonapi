                    ...
                    if (relation_value.data) {
                        if (_this.schema.relationships[relation_key] && _this.schema.relationships[relation_key].hasMany) {
                            ...
                            if (relation_value.data.id) {
                                // we use relation_value.data[0].type, becouse maybe is polymophic
                                var resource_service = Jsonapi.Converter.getService(relation_value.data.type);
                                if (resource_service) {
                                    // recorro los resources del relation type
                                    var relationship_resources = {};
                                    // angular.forEach(relation_value.data, (resource_value: Jsonapi.IDataResource) => {
                                    // está en el included?
                                    var tmp_resource = void 0;
